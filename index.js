...
<head>
    ...
    <meta name="description" content="Convert WordPress icons from @wordpress/icons package into a custom icon font. Browse all ${iconNames.length} icons with search functionality.">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="WordPress Icons Font Preview">
    <meta property="og:description" content="Convert WordPress icons from @wordpress/icons package into a custom icon font. Browse all ${iconNames.length} icons with search functionality.">
    ...
    <meta name="twitter:title" content="WordPress Icons Font Preview">
    <meta name="twitter:description" content="Convert WordPress icons from @wordpress/icons package into a custom icon font. Browse all ${iconNames.length} icons with search functionality.">
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="header-buttons">
                <a href="https://github.com/krstivoja/wordpress-icons-font" target="_blank" class="btn btn-github" target="_blank>
                    <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z"/>
                    </svg>
                    View on GitHub
                </a>
                <a href="https://www.npmjs.com/package/wordpress-icons-font" target="_blank" class="btn btn-npm" target="_blank>
                    <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 0v16h16V0H0zm13 13H8v-2H5v2H3V3h10v10z"/>
                    </svg>
                    View on npm
                </a>
                <a href="https://github.com/dplugins-opensource/wordpress-icons-font/tree/main/dist" class="btn btn-download" target="_blank>
                    <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
...
${iconNames.map(name => `            <div class="icon-item" data-name="${name}" onclick="copyIconClass('wpi-${name}')">
    ...
    console.log('  • preview.css            - Separate stylesheet (edit manually)');
    console.log('\n📖 Usage:');
